...
// Buổi 6 - Phần 2: API lấy danh sách bài viết thời trang mẫu dạng JSON
...
namespace CMS.Backend.Controllers
{
    ...
    public class PostsController : ControllerBase
    {
        ...
        // ==============================================================
        // Chỉ định phương thức GET (Dùng để kéo dữ liệu từ cơ sở dữ liệu)
        [HttpGet]
        public async Task<IActionResult> GetAll()
        {
            ...
            var posts = await _context.Posts
                ...
                .Select(p => new {            // "Gọt tỉa" dữ liệu (Projection): chỉ lấy những trường cần thiết ra trang chủ
                    p.Id,
                    p.Title,
                    p.ImageUrl,
                    p.CreatedDate,
