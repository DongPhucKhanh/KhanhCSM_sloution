...
// Chức năng: Component tự làm hiển thị danh sách chủ đề bài viết blog (Mở rộng Buổi 8)
...
const BlogCategoryList = () => {
    ...
    return (
        <div className="card shadow-sm p-3 mt-4 bg-white rounded border">
            <h5 className="card-title text-uppercase font-weight-bold text-secondary" style={{ fontSize: '1rem' }}>
                <i className="fa-solid fa-tags mr-2 text-info"></i> Chủ đề bài viết
            </h5>

            <div className="list-group list-group-flush mt-2">
                {blogCategories.length === 0 ? (
                    <p className="text-muted small pl-2 m-0">Chưa có chủ đề tin tức nào.</p>
                ) : (
