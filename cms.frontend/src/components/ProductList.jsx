                        ...
                        <div className="card h-100 shadow-sm border">
                            <div className="card-body">
                                ...
                                <p className="card-text small text-muted">
                                    {/* LƯU Ý: Nếu DB trả về trường camelCase là stockQuantity, Khoa có thể điều chỉnh item.stock thành item.stockQuantity cho khớp */}
                                    Số lượng tồn kho: {item.stock || item.stockQuantity} sản phẩm
                                </p>
                            </div>
