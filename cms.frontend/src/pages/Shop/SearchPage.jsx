                        ...
                        <div className="classic-sidebar bg-white mb-4 shadow-sm border border-top-0">
                            ...
                            <div className="sidebar-content p-3">
                                <div className="custom-control custom-radio mb-3">
                                    <input type="radio" id="price-search-all" name="priceSearchFilter" className="custom-control-input"
                                        checked={!urlMinPrice && !urlMaxPrice}
                                        onChange={handleClearPrice} />
                                    <label className="custom-control-label cursor-pointer text-dark font-weight-bold" htmlFor="price-search-all">Tất cả mức giá</label>
                                </div>
                                <div className="custom-control custom-radio mb-3">
                                    <input type="radio" id="price-search-1" name="priceSearchFilter" className="custom-control-input"
                                    ...
                                    <label className="custom-control-label cursor-pointer text-dark" htmlFor="price-search-1">Dưới 1.000.000 đ</label>
                                </div>
                                <div className="custom-control custom-radio mb-3">
                                    <input type="radio" id="price-search-2" name="priceSearchFilter" className="custom-control-input"
                                    ...
                                    <label className="custom-control-label cursor-pointer text-dark" htmlFor="price-search-2">Từ 1.000.000 đ - 3.000.000 đ</label>
                                </div>
                                <div className="custom-control custom-radio mb-4">
                                    <input type="radio" id="price-search-3" name="priceSearchFilter" className="custom-control-input"
                                    ...
                                    <label className="custom-control-label cursor-pointer text-dark" htmlFor="price-search-3">Trên 3.000.000 đ</label>
                                </div>
                                ...
                                <form onSubmit={handleApplyPrice}>
                                    ...
                                    <div className="row no-gutters">
                                        <div className="col-6 pr-1">
                                            <button type="submit" className="btn btn-danger btn-block btn-sm font-weight-bold text-uppercase shadow-sm">Áp dụng</button>
                                        </div>
                                        <div className="col-6 pl-1">
                                            <button type="button" onClick={handleClearPrice} className="btn btn-light border btn-block btn-sm font-weight-bold text-uppercase text-muted shadow-sm">Xóa lọc</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
